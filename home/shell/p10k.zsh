# Generated by Powerlevel10k configuration wizard on 2021-12-10 at 22:18 CET.
...
() {
  ...
  ###########################[ vim_shell: vim shell indicator (:h) ]###########################
  ...
  typeset -g POWERLEVEL9K_NIX_SHELL_CONTENT_EXPANSION='${NIX_SHELL_NAME}'
